            ...
            {#each imageURLs as imageURL}
                <img 
                    ...
                    alt={`${(imageURL.replace(".png", "")
                                     .replace("/static/images/company-logos/", "")
                            )} company logo`}
                    class="company-logos"
                >
            {/each}
